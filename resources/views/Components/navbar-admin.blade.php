            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <div id="ropdown" class="hidden absolute right-0 mt-2 w-44 bg-white rounded-md shadow-lg py-2 border">
                            </div>
                            <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 border-b-2 border-transparent">
                                Kelola
                            </a>
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center relative">
                    ...
                    <!-- Dropdown -->
                    <div id="Dropdown" class="hidden absolute right-0 mt-2 w-44 bg-white rounded-md shadow-lg py-2 border">
                        <a href="/profile" 
